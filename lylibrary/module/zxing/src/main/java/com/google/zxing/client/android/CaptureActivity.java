 ...
 * @author Sean Owen
 */
public abstract class CaptureActivity extends Activity implements SurfaceHolder.Callback ,IScanSuccess{
   ...
   *当扫到一个有效的条码，返回扫码的结果信息
   * @param rawResult The contents of the barcode. 这个条码的内容
   */
